...
class TheScene extends THREE.Scene {
  ...
  createLights () {
    ...
    //EXAMEN - COMIENZA AQUI
    this.nuevaLuz = new THREE.AmbientLight(0xffffff, 0.7);
    this.add (this.nuevaLuz);

    this.spotNuevaLuz = new THREE.SpotLight(0x0101DF);
    this.spotNuevaLuz.position.set(-30,30,20); //colocar luz en la posicion indicada
    this.spotNuevaLuz.castShadow = true; //Generar sombras
    this.spotNuevaLuz.shadow.mapSize.width=2048 //resolucion de las sombras
    this.spotNuevaLuz.shadow.mapSize.height=2048;
    this.add (this.spotNuevaLuz);
    //EXAMEN - ACABA AQUI
  }
