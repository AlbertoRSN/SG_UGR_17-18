...
class Crane extends THREE.Object3D {
  ...
  constructor (parameters) {
    ...
    this.material    = (parameters.material === undefined ? new THREE.MeshPhongMaterial ({map: texturaGrua}) : parameters.material);
    ...
    //this.material    = (parameters.material === undefined ? new THREE.MeshPhongMaterial ({color: 0xf2f5a9, specular: 0xEEEEEE, shininess: 70}) : parameters.material);
  ...
  createBase () {
    var base = new THREE.Mesh (
      //new THREE.CylinderGeometry (this.craneWidth/10, this.craneWidth/10, this.baseHookHeight, 16, 1), 
        //                       this.material);
      new THREE.BoxGeometry (this.craneWidth/5, this.craneWidth/10, this.craneWidth/5),this.material);
    base.geometry.applyMatrix (new THREE.Matrix4().makeTranslation (0, this.craneWidth/20, 0));
  ...
  createTrolleyStringHook () {
    ...
    this.string = new THREE.Mesh (
      new THREE.CylinderGeometry (this.craneWidth/200, this.craneWidth/200, 1), this.material);
