...
class TheScene extends THREE.Scene {
  ...
  createModel () {
    ...
    this.crane = new Crane(30, 45, new THREE.MeshPhongMaterial ({map: texturaGrua}));
  ...
  animate (controls) {
    ...
    if(!controls.activarGrua){
      this.crane.setHookPosition (controls.rotation, controls.distance, controls.height);
    }
    else{
      this.crane.setHookPosition (10.5, 25, 25);
    }

    //SOLTAR LA CAJA CUANDO LA ALTURA ES MAYOR DE 20
