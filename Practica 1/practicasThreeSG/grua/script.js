...
function createGUI (withStats) {
  ...
  var nuevasOpciones = gui.addFolder('Nuevas Opciones');
    var nuevaL = nuevasOpciones.add(GUIcontrols, 'nuevaLuz').name('Nueva Luz: ');//para el boton de encender y apagar la nueva luz.
    
    nuevaL.onChange (function (value) {
        if(value){
          setMessage ("Nueva Luz Activada");
        }
        else{
          setMessage ("Nueva Luz Desactivada");
        }
      });

    var activaG = nuevasOpciones.add(GUIcontrols, 'activarGrua').name('Activar Pos. Grua');
